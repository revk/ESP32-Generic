...
difference(){bottom();translate([0.000000,0.000000,-0.001])scale([-1,1])linear_extrude(0.500000)text("2025-08-25",size=3.000000,halign="center",valign="center",font="OCRB");}