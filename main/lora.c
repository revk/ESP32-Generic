...
lora_init (void)
{
    ...
    */
   revk_gpio_output (lorarest, 0);
   revk_gpio_output (loranss, 1);

   spi_bus_config_t bus = {
      .miso_io_num = loramiso.num,
      .mosi_io_num = loramosi.num,
      .sclk_io_num = lorasck.num,
      .quadwp_io_num = -1,
      .quadhd_io_num = -1,
      .max_transfer_sz = 0
   };
